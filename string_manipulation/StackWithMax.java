...
import stack_operations.EmptyCollectionException;
import stack_operations.FullCollectionException;
import stack_operations.StackADT;

public class StackWithMax<T> implements StackADT<T> {
	...
	public void push(T element) {
		...
		try {
			...
			//checks if stack is full, if full throws Full Collection Exception
			if(this.topOfStack + 1 < this.stackSize) {
				if(maxEle < ((int)stack[topOfStack])) {
