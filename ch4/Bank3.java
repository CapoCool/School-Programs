...
public class Bank3
{
	public static void main( String [ ] args)
	{
		...
		BankAccount3 studentAcct = new BankAccount3();
		...
		BankAccount3 teacherAcct = new BankAccount3(4444, 1500.00, "James Gosling");
		...
		System.out.println("\nThe Bank has " + BankAccount3.getCount() + " Accounts." );
