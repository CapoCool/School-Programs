 ...
 *12/07/2019
 *CSC205
 *A class that has all the sorting algorithms
 * 
 */
...
public class SortingUtility {
	 ...
	 */
	static <T extends Comparable<T>> void quickSort(T[] data, int min, int max) {
	 ...
	 */
	static <T extends Comparable<T>> void mergeSort(T[] data, int min, int max) {
